    ...
    <nav>
     ...
     <?php
        ...
        if($user_name && $password && $id)
        {
            ...
            if ($conn->query($sql)) echo "<p style='text-align:center'>The account has been succesfully updated.</p>";
            else echo "<p style='text-align:center'>Sth went wrong: ".$conn->error."</p>";
        }
        else echo "<p style='text-align:center'>Incorrect data.</p>";
        echo "<a href='all_accounts.php' class='back-button'>BACK</a>";
     ?>
    </section>
